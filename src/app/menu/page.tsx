            ...
            <div className="flex flex-col lg:flex-row gap-12 mb-14 items-start">
              ...
              <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-4">
                {category.items.map((item, itemIdx) => (
                  <div
                    key={itemIdx}
                    className={`group relative w-full p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border transition-all duration-300 hover-lift min-h-[196px] md:min-h-0 flex flex-col ${
                      item.highlight
